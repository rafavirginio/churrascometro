...
function calcular() {
  ...
  resultado.innerHTML = `<p>${qtdTotalCarne/1000} Kg de Carne(linguiça, carne, frango etc. )</p>`
  resultado.innerHTML += `<p>${Math.ceil(qtdTotalCerveja/355)} Latas de Cerveja 355ml</p>`
  resultado.innerHTML += `<p>${Math.ceil(qtdTotalBebidas)/2000} Pack's de 2L de Bebidas</p>`
